        ...
        <div className={styles.payment} onClick={() => setstate(false)}>
          <div onClick={onchanges}>
            ...
            <Radio.Group onChange={onBJChange} value={`${BJ}+${FY}`}>
              {
                KcDetail?.KHBJSJs?.map((value: { BJMC: string, id: string, FJS: string, FY: string, BMKSSJ: Date, BMJSSJ: Date, BJRS: number }, ind: number) => {
                  ...
                  return (
                    ...
                    <Radio.Button value={valueName} style={{ marginRight: '14px' }}
                      disabled={!enAble}
