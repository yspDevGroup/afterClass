            ...
            <div>
              ...
              >
                <div className={styles.cards} style={{ height: '80px' }}>
                  ...
                  <div>
                    <p className={styles.title}>{BaoMinData?.[0]?.XSFWBJs?.[0]?.KHFWBJ?.FWMC}</p>
                    <p>
                      服务时段：{BaoMinData?.[0]?.XSFWBJs?.[0].KHFWBJ?.KHFWSJPZs?.[0]?.KSRQ} ~{' '}
                      {
                        BaoMinData?.[0]?.XSFWBJs?.[0].KHFWBJ?.KHFWSJPZs?.[
                          BaoMinData?.[0]?.XSFWBJs?.[0].KHFWBJ?.KHFWSJPZs?.length - 1
                        ]?.JSRQ
                      }
                    </p>
                  </div>

                  <Checkbox value={BaoMinData?.[0]?.id} />
                </div>
              </Checkbox.Group>
            </div>
          </div>
