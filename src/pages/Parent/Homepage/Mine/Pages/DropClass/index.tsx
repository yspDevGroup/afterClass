 ...
 * @LastEditTime: 2021-09-30 17:18:28
 * @LastEditors: zpl
 */
          ...
          {KcData?.length !== 0 ? (
            <>
                          ...
                          {value.KHBJSJ?.KHXSCQs.length === 0 ? (
                            <div className={styles.cards}>
                              ...
                              <Checkbox
                                ...
                                disabled={newDate < JKRQ && newDate - JKRQ < 2592000000}
                              >
                                {' '}
                              </Checkbox>
                            </div>
              ...
              <div className={styles.wrap}>
                <p>
                  结课后才可退课，退课退款规则详见 <a onClick={showModal}>《课后服务协议》</a>
                </p>
                  ...
                  return (
                    <div className={styles.cards}>
                      ...
                      <p
                        ...
                        style={{ color: value.ZT === 0 ? '#FF6600' : '#45C977' }}
                      >
                        {value.ZT === 0 ? '申请中' : value.ZT === 1 ? '已退课' : '退课失败'}
                      </p>
                    </div>
                  );
                })}
