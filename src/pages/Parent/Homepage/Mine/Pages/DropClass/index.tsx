                ...
                >
                  <div className={styles.cards}>
                    <p className={styles.title}>
                      ...
                      {
                        value?.KHBJSJ ? <> {value.KHBJSJ?.KHKCSJ?.KCMC}
                          <span style={{ color: '#009688', fontWeight: 'normal' }}>
                            【{value.KHBJSJ?.BJMC}】
                          </span></> : <></>
                      }
                    ...
                    {
                      value?.XSFWBJ ? <>
                        <p>服务时段：{value?.XSFWBJ?.KHFWSJPZ?.KSRQ} ~ {value?.XSFWBJ?.KHFWSJPZ?.JSRQ}</p>
                        <p>申请日期：{value?.createdAt?.split(' ')[0]}</p>
                      </> : <></>
                    }
                    <p className={styles.state}>
                      ...
                      {value.ZT === 1 && value?.KHXSTKs?.length === 0 ? <span style={{ color: '#15B628' }}>退订成功</span> : ''}
                      ...
                      {value?.KHXSTKs?.length !== 0 && value?.KHXSTKs?.[0].TKZT === 3 ? <span style={{ color: '#15B628' }}>退款成功</span> : ''}
