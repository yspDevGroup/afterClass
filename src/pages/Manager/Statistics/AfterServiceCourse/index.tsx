...
import { getFWClasses, getFWTJByXZB, statisticalKHFWBJ, statisticalKHFWXZB, summaryFWBTJ } from '@/services/after-class/reports';
      ...
      <div className={Style.TopCards}>
        ...
        <div>
          <div>
            ...
            <div>
              <h3>
                {collectData?.skje_count ? Number(collectData?.skje_count).toFixed(2) : 0}
              </h3>
              <p>收款累计金额</p>
            </div>
          </div>
