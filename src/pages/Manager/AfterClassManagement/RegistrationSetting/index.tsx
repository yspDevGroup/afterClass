...
const RegistrationSetting = () => {
  ...
  const getmonthSetting = () => {
    return (
      <Space wrap>
        {initDataSource
          ?.filter((item: DataSourceType) => item.type === JFLX)
          .map((item: DataSourceType) => (
            <Checkbox
              disabled={disable}
  ...
  const columnsPay: ProColumns<any>[] = [
    ...
    },
    {
      ...
      render: (text) =>
        text === 1 ? (
          <span style={{ color: '#41BC00' }}>已开启</span>
        ) : (
                  ...
                  headerTitle={
                    <SearchLayout>
                      ...
                      <div>
                        ...
                        >
                          <Option value={1}>已开启</Option>;<Option value={0}>已关闭</Option>;
                        </Select>
                      </div>
                    </SearchLayout>
                  }
