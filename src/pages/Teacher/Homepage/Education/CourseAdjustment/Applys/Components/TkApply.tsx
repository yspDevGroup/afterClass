  ...
  return (
    <div className={styles.leaveForm}>
      <div className={styles.wrapper}>
        ...
        <Tabs activeKey={curType} className={styles.arrangeTab} onChange={(key: string) => setCurType(key)}>
                      ...
                      if (e) {
                        ...
                        if (res.status === 'ok' && res.data) {
                          const newList = [].map.call(res.data.rows, (v: any) => {
                            ...
                            const mainTeacher = KCBSKJSSJs.find((val: { JSLX: number; }) => val.JSLX === 1);
                            return {
                  ...
                  >
                    {
                      adminClass?.map((value: any) => {
                        return <Option value={value.bjid} key={value.bjid}>
